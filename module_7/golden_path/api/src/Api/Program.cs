...
builder.Services.AddInfrastructure(builder.Configuration, overrideConnectionString)
...
app.Map("/health", async () =>
{
    ...
    var ordersDbContext = scope.ServiceProvider.GetRequiredService<DbContext>();
