...
var applicationName = "delivery-service";
...
builder.Services.AddDeliveryModuleInfrastructure(builder.Configuration, overrideConnectionString)
    ...
    }, typeof(DriverCollectedOrderEventV1).Assembly, typeof(OrderReadyForDeliveryEventV1).Assembly)
    ...
    }, typeof(OrderReadyForDeliveryEventV1).Assembly)
    .AddHttpClient();
